...
Class PMS_Payment_Gateway_PayU extends PMS_Payment_Gateway {
    ...
    */
    ...
    public function init() {
        ...
        $this->recurring  = 1;
        $this->supports = apply_filters( 'pms_payment_gateway_payu_supports', array( 'gateway_scheduled_payments', 'recurring_payments', 'credit_card' ) );
    ...
    public function process_sign_up() {
      ...
      if($this->recurring == 1){
        //web_accept_payu - one time payment\
        $payment->update( array( 'type' => apply_filters( 'pms_payu_payment_type', 'subscription_recurring_payment', $this, $settings ) ) );
      } else {
        //web_accept_payu - one time payment\
