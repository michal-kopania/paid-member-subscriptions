...
//OpenPayU SDK
        ...
        if( file_exists( PMS_PLUGIN_DIR_PATH . 'includes/gateways/payu/class-ipn-verify.php' ) )
            include_once PMS_PLUGIN_DIR_PATH . 'includes/gateways/payu/class-ipn-verify.php';
